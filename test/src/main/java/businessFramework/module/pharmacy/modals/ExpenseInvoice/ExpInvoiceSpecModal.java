...
public class ExpInvoiceSpecModal extends ExpInvoiceSpecHelper
{
    public ExpInvoiceSpecModal(ApplicationManager app)
    {
        super(app);
    }
    ...
    {
        getExpInvoiceSpecificationModal().assertModalHeader_equal(expectedHeader);
    }
    ...
    {
        getExpInvoiceSpecificationModal().closeModal();
    }
}
