...
import businessFramework.module.pharmacy.modals.TransferAct.TransferActSpecModal;
 ...
 */
public class TransferActCreateSpecPage  extends TransferActCreateSpecHelper
{

    public int row = 0;

    public TransferActCreateSpecPage(ApplicationManager app)
    {
        super(app);
    }
     ...
     */
    public TransferActSpecModal getTransferActSpecModal()
    {
        return new TransferActSpecModal(app);
    }
    ...
    /**
     * Проверяет значения полей в таблице "Спецификация" после добавления спецификации на странице "Акты переброски - ... добавление спецификации"
     *
    ...
    /**
     * Нажимает кнопку "Изменить" в контейнере "Спецификации" на странице "Акты переброски - ... добавление спецификации"
     */
    ...
    /**
     * Нажимает кнопку "Назад" на странице "Акты переброски - ... добавление спецификации"
     */
