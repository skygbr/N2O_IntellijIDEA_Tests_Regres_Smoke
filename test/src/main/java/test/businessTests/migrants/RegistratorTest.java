package test.businessTests.migrants;
...
public class RegistratorTest extends TestBase
{
    ...
    public void initialize() throws CloneNotSupportedException
    {
        ...
        md.setContextName("Подразделение для ОИГИЛГ");


        // Данные в полях на форме в контейнере “Карточка мероприятия”
        md.setEventName("ОИГИЛГ");                              // Название мероприятия
        md.setEventTypeValue("Освидетельствование ИГ и ЛГ");    // Значение поля "Вид мероприятия"
        md.setOrganisationValue("ОИГИЛГ");                      // Значение поля "Организация"
        md.setFinancingTypeValue("Средства граждан");           // Значение поля "Вид финансирования"
        md.setBeginDateValue("01.01.2015");                     // Значение поля "Дата начала"
        md.setEndDateValue("31.12.2015");                       // Значение поля "Дата окончания"
        md.setStandartValue("Осмотр ИГ и ЛГ");                  // Значение поля "Стандарт лечения"

        // Данные для изменения значений на форме в контейнере "Карточка мероприятия"
        md.setEventNameValueEdited("ОИГИЛГ тестирование изменений");
        md.setBeginDateValueEdited("02.02.2015");
        md.setEndDateValueEdited("28.12.2015");
        ...
        md.setPatientSearchSurname("Диспансеризация");
        md.setPatientSearchName("Мигрант");
        md.setPatientSearchPatrName("Гибдд");
        md.setPatientSearchBirthDate("01.01.1990");
        md.setPatientSearchDocNumber("1234567891");

        // Данные для заполнение полей в модальном окне "Выполнение услуги"
        md.setServiceExecutionOrganisation("ОИГИЛГ");
